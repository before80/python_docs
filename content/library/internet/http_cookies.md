...
*attrs* 的含义与 [`output()`]({{< ref "/library/internet/http_cookies#http.cookies.BaseCookie.output" >}}) 的相同。
...
> 在 3.8 版本发生变更: 增加对 [`samesite`]({{< ref "/library/internet/http_cookies#http.cookies.Morsel.samesite" >}}) 属性的支持。
