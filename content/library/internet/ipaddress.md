...
​	网络对象可以被迭代，以列出属于该网络的所有地址。 对于迭代，*所有* 主机都会被返回，包括不可用的主机（对于可用的主机，使用 [`hosts()`]({{< ref "/library/internet/ipaddress#ipaddress.IPv4Network.hosts" >}}) 方法）。 一个例子:
