...
​	如果某个段为绝对路径，则其前面的所有段都会被忽略 (类似 [`os.path.join()`]({{< ref "/library/filesys/os_path#os.path.join" >}})):
...
​	文件对象可用于任何接受 [`os.PathLike`]({{< ref "/library/allos/os#os.PathLike" >}}) 接口实现的地方。
...
​	如果路径以超过两个连续斜框打头，[`PurePosixPath`]({{< ref "/library/filesys/pathlib#pathlib.PurePosixPath" >}}) 会合并它们:
...
​	一个 [`PurePath`]({{< ref "/library/filesys/pathlib#pathlib.PurePath" >}}) 的子类，此类以当前系统的路径风格表示路径（实例化为 [`PosixPath`]({{< ref "/library/filesys/pathlib#pathlib.PosixPath" >}}) 或 [`WindowsPath`]({{< ref "/library/filesys/pathlib#pathlib.WindowsPath" >}})）:
...
​	某些具体路径方法在一个系统调用失败时（例如由于路径不存在）可能引发 [`OSError`]({{< ref "/library/exceptions#OSError" >}})。
...
## 与 [`os`]({{< ref "/library/allos/os#module-os" >}}) 和 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 模块的比较

​	pathlib 使用 [`PurePath`]({{< ref "/library/filesys/pathlib#pathlib.PurePath" >}}) 和 [`Path`]({{< ref "/library/filesys/pathlib#pathlib.Path" >}}) 对象来实现路径操作，因此它被认为是 *面向对象的*。 而在另一方面，[`os`]({{< ref "/library/allos/os#module-os" >}}) 和 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 模块提供与低层级 `str` 和 `bytes` 对象配合使用的函数，它更接近于 *面向过程的* 方式。 某些用户认为面向对象的风格可读性更好。

[`os`]({{< ref "/library/allos/os#module-os" >}}) 和 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 中的许多函数都支持 `bytes` 路径和 [相对于目录描述符的路径]({{< ref "/library/allos/os#dir-fd" >}})。 这些特性在 pathlib 中均不可用。

​	Python 的 `str` 和 `bytes` 类型，以及 [`os`]({{< ref "/library/allos/os#module-os" >}}) 和 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 模块的各个部分都是用 C 编写的因而非常快速。 pathlib 是用纯 Python 编写的因而往往较慢，但很少会慢到引人注意。

​	pathlib 的路径规范化比 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 更有主见也更一致。 例如，[`os.path.abspath()`]({{< ref "/library/filesys/os_path#os.path.abspath" >}}) 会删除路径中的 "`..`" 段，因为当涉及符号链接时这可能会改变其含义；而 [`Path.absolute()`]({{< ref "/library/filesys/pathlib#pathlib.Path.absolute" >}}) 则会保留这些段以提高安全性。
...
​	由于这些差异的影响，pathlib 并不是 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) 的直接替代品。

### 相关工具

​	以下是一个映射了 [`os`]({{< ref "/library/allos/os#module-os" >}}) 与 [`PurePath`]({{< ref "/library/filesys/pathlib#pathlib.PurePath" >}})/[`Path`]({{< ref "/library/filesys/pathlib#pathlib.Path" >}}) 对应相同的函数的表。

| [`os`]({{< ref "/library/allos/os#module-os" >}}) 和 [`os.path`]({{< ref "/library/filesys/os_path#module-os.path" >}}) | [`pathlib`]({{< ref "/library/filesys/pathlib#module-pathlib" >}}) |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| [`os.path.dirname()`]({{< ref "/library/filesys/os_path#os.path.dirname" >}}) | [`PurePath.parent`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.parent" >}}) |
| [`os.path.basename()`]({{< ref "/library/filesys/os_path#os.path.basename" >}}) | [`PurePath.name`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.name" >}}) |
| [`os.path.splitext()`]({{< ref "/library/filesys/os_path#os.path.splitext" >}}) | [`PurePath.stem`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.stem" >}}), [`PurePath.suffix`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.suffix" >}}) |
| [`os.path.join()`]({{< ref "/library/filesys/os_path#os.path.join" >}}) | [`PurePath.joinpath()`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.joinpath" >}}) |
| [`os.path.isabs()`]({{< ref "/library/filesys/os_path#os.path.isabs" >}}) | [`PurePath.is_absolute()`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.is_absolute" >}}) |
| [`os.path.relpath()`]({{< ref "/library/filesys/os_path#os.path.relpath" >}}) | [`PurePath.relative_to()`]({{< ref "/library/filesys/pathlib#pathlib.PurePath.relative_to" >}}) [[1\]]({{< ref "/library/filesys/pathlib#id7" >}}) |
| [`os.path.expanduser()`]({{< ref "/library/filesys/os_path#os.path.expanduser" >}}) | [`Path.expanduser()`]({{< ref "/library/filesys/pathlib#pathlib.Path.expanduser" >}}) [[2\]]({{< ref "/library/filesys/pathlib#id8" >}}) |
| [`os.path.realpath()`]({{< ref "/library/filesys/os_path#os.path.realpath" >}}) | [`Path.resolve()`]({{< ref "/library/filesys/pathlib#pathlib.Path.resolve" >}}) |
| [`os.path.abspath()`]({{< ref "/library/filesys/os_path#os.path.abspath" >}}) | [`Path.absolute()`]({{< ref "/library/filesys/pathlib#pathlib.Path.absolute" >}}) [[3\]]({{< ref "/library/filesys/pathlib#id9" >}}) |
| [`os.path.exists()`]({{< ref "/library/filesys/os_path#os.path.exists" >}}) | [`Path.exists()`]({{< ref "/library/filesys/pathlib#pathlib.Path.exists" >}}) |
| [`os.path.isfile()`]({{< ref "/library/filesys/os_path#os.path.isfile" >}}) | [`Path.is_file()`]({{< ref "/library/filesys/pathlib#pathlib.Path.is_file" >}}) |
| [`os.path.isdir()`]({{< ref "/library/filesys/os_path#os.path.isdir" >}}) | [`Path.is_dir()`]({{< ref "/library/filesys/pathlib#pathlib.Path.is_dir" >}}) |
| [`os.path.islink()`]({{< ref "/library/filesys/os_path#os.path.islink" >}}) | [`Path.is_symlink()`]({{< ref "/library/filesys/pathlib#pathlib.Path.is_symlink" >}}) |
| [`os.path.isjunction()`]({{< ref "/library/filesys/os_path#os.path.isjunction" >}}) | [`Path.is_junction()`]({{< ref "/library/filesys/pathlib#pathlib.Path.is_junction" >}}) |
| [`os.path.ismount()`]({{< ref "/library/filesys/os_path#os.path.ismount" >}}) | [`Path.is_mount()`]({{< ref "/library/filesys/pathlib#pathlib.Path.is_mount" >}}) |
| [`os.path.samefile()`]({{< ref "/library/filesys/os_path#os.path.samefile" >}}) | [`Path.samefile()`]({{< ref "/library/filesys/pathlib#pathlib.Path.samefile" >}}) |
| [`os.getcwd()`]({{< ref "/library/allos/os#os.getcwd" >}}) | [`Path.cwd()`]({{< ref "/library/filesys/pathlib#pathlib.Path.cwd" >}}) |
