...
​	在可用且有效时将使用 [`os.O_TMPFILE`]({{< ref "/library/allos/os#os.O_TMPFILE" >}}) 旗标（Linux 专属，需要 Linux 内核版本为 3.11 或更高）。
...
> 在 3.12 版本发生变更: [`mkdtemp()`]({{< ref "/library/filesys/tempfile#tempfile.mkdtemp" >}}) 现在将始终返回绝对路径，即使 *dir* 为相对路径。
