...
[`Cmd`](https://docs.python.org/zh-cn/3.13/library/cmd.html#cmd.Cmd) 实例有下列方法：
...
​	要作为简介或横幅发出的字符串。 可以通过给 [`cmdloop()`](https://docs.python.org/zh-cn/3.13/library/cmd.html#cmd.Cmd.cmdloop) 方法一个参数来覆盖它。
