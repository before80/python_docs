...
​	如果发生任何错误则将引发 [`error`](https://docs.python.org/zh-cn/3.13/library/zlib.html#zlib.error) 异常。
...
## 模块 [`gzip`](https://docs.python.org/zh-cn/3.13/library/gzip.html#module-gzip)
