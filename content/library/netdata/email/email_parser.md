...
​	除了 *headersonly* 默认为 `True` ，其他与 [`Parser`](https://docs.python.org/zh-cn/3.13/library/email.parser.html#email.parser.Parser) 类完全一样。
