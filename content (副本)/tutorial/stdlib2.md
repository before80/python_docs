...
[`locale`]({{< ref "/library/i18n/locale#module-locale" >}}) 模块处理与特定地域文化相关的数据格式。locale 模块的 format 函数包含一个 grouping 属性，可直接将数字格式化为带有组分隔符的样式:
...
[`decimal`]({{< ref "/library/numeric/decimal#module-decimal" >}}) 模块提供了运算所需要的足够精度:
